...
<body>
	<c:if test="${isLoginFailed}">
		<div class="alert alert-warning" style="margin-bottom: 0px;">
			<strong>Login not successful! </strong> Please check your email or
			password. Also, make sure your user status is Active!
		</div>
	</c:if>
	...
	<footer class="page-footer font-small"
		...
		<div class="footer-copyright text-center py-4"
			...
			© 2021 <a href="https://www.kishorkadam.com/"> Kishor Kadam </a>
		</div>
	</footer>
